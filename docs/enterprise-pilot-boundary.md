...
collects eleven v2 evidence sections without exposing arbitrary payload text.
Identity rejections remain deployment-scoped because unsigned team headers are
