  ...
  it('renders Qwen Cloud hackathon proof signals with live health metadata', () => {
    ...
    showcaseRequest.flush({
      ...
      experience_benchmark: {
        ...
        lifecycle_key_stability: 1,
        qwen_receipt_coverage: 1,
        qwen_receipt_count: 37,
        qwen_total_tokens: 28730,
        overall_score: 100,
  ...
  return {
    decision: {
      ...
      llm_receipt: {
        ...
        requested_at: '2026-07-10T05:00:00Z',
        completed_at: '2026-07-10T05:00:01Z',
        latency_ms: 1000,
        provider_request_id: `dashscope-${sessionId}`,
        response_id: `chatcmpl-${sessionId}`,
      },
      created_at: '2026-07-10T05:00:00Z',
    },
