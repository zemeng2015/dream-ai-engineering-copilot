---
title: "Athena Preview Timeout Runbook"
doc_type: "runbook"
team_id: "demo_team"
app: "ForecastDemo"
...
concepts:
  - operator
  - runbook
  - athena preview timeout runbook
related_code:
...
## Purpose
Guides Operators through this synthetic DFP scenario: Large output preview query exceeds timeout.

## Domain Context
Operators connect UI symptoms, backend status, orchestration events, processor output, and storage artifact metadata.

## Key Behaviors
- Confirm partition predicate, row limit, query id, and fallback download message.
