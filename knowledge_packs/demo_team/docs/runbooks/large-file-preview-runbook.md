---
title: "Large File Preview Runbook"
doc_type: "runbook"
team_id: "demo_team"
app: "ForecastDemo"
...
## Purpose
Guides Operators through this synthetic DFP scenario: Output Preview cannot safely load a large result file.

## Domain Context
Operators connect UI symptoms, backend status, orchestration events, processor output, and storage artifact metadata.

## Key Behaviors
- Verify size threshold, direct preview disablement, Athena-style query routing, and pagination.
