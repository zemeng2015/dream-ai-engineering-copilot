---
title: "Output Collection Design"
...
# Output Collection Design

## Purpose
Defines output artifact collection and retry idempotency.

## Domain Context
OutputCollector reads manifests, verifies storage metadata, writes OutputArtifact records, and prevents duplicate result files.
