...
## Purpose
Describes the UI surfaces for Analysts, Operators, and Admins.

## Domain Context
The UI is dense and workflow-oriented: Job List, Job Detail, Execution Monitor, Output Preview, and Admin Workflow Console.
