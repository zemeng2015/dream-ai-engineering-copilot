...
## Purpose
Describes controllers, services, domain models, adapters, and collectors.

## Domain Context
Java backend owns API contracts, business decisions, status persistence, output collection, and adapter boundaries.
