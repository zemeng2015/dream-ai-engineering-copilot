...
---
    ...
    ## Summary
    INC-107: Large output preview query exceeded timeout due to missing partition predicate.
    ...
    ## Root Cause
    AthenaPreviewAdapter accepted preview requests without execution partition filter.
...
- frontend/src/app/execution/execution-monitor.component.ts
    ...
    ## Regression Tests
    Add deterministic tests for the status, retry, output, permission, or preview branch that triggered INC-107.
