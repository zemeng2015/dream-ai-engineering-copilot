...
---
    ...
    ## Summary
    INC-103: Python processor completed successfully, but StatusTracker failed to persist COMPLETED. UI showed RUNNING forever.
    ...
    ## Root Cause
    Persistence error was logged but not surfaced as stale status or retryable update.
...
- PR-505
    ...
    ## Regression Tests
    Add deterministic tests for the status, retry, output, permission, or preview branch that triggered INC-103.
