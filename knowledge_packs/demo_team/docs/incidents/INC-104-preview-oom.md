...
---
    ...
    ## Summary
    INC-104: Output Preview page attempted to load a full 1.5GB result file instead of paginated preview.
    ...
    ## Root Cause
    UI direct preview path did not enforce backend size threshold metadata.
...
- DFP-104
    ...
    ## Regression Tests
    Add deterministic tests for the status, retry, output, permission, or preview branch that triggered INC-104.
