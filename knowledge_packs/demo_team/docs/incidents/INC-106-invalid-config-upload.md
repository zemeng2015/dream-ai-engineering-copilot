...
---
    ...
    ## Summary
    INC-106: User uploaded task-level config with missing required field. Failure was not caught until execution time.
    ...
    ## Root Cause
    InputValidator was called during batch execution but not before Execution creation.
...
- frontend/src/app/execution/execution-monitor.component.ts
    ...
    ## Regression Tests
    Add deterministic tests for the status, retry, output, permission, or preview branch that triggered INC-106.
