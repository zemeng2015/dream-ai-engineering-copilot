---
title: "Partial completion undefined"
doc_type: "incident"
team_id: "demo_team"
app: "ForecastDemo"
...
---
    ...
    ## Summary
    INC-105: One task failed while other tasks completed. Product behavior for partial result availability was not defined.
    ...
    ## Root Cause
    Workflow did not classify optional vs critical tasks and ExecutionStatus lacked PARTIAL_SUCCESS.
...
- frontend/src/app/execution/execution-monitor.component.ts
    ...
    ## Regression Tests
    Add deterministic tests for the status, retry, output, permission, or preview branch that triggered INC-105.
