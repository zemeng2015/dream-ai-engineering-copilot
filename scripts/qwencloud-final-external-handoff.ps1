...
$lines += @(
    ...
    '5. Configure Serverless Devs default access from local environment variables and run deploy preflight build+smoke.',
    '6. Run `qwencloud-alibaba-runtime-release.ps1` locally; the ACR-based GitHub release workflow is an optional fallback.',
